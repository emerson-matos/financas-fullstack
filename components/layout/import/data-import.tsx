...
async function parseOfxFiles(
  ...
  if (successful.length > 0) {
    ...
    aggregated = successful.reduce((acc, cur) => {
      ...
      acc.statistics.total_records += res.statistics.total_records;
      acc.statistics.successful_records += res.statistics.successful_records;
      acc.statistics.failed_records += res.statistics.failed_records;
...
function computeAggregatedResult(
  ...
  return {
    ...
    statistics: {
      total_records: safeBase.statistics.total_records + csvCount,
      successful_records: safeBase.statistics.successful_records + csvCount,
      failed_records: safeBase.statistics.failed_records,
    },
                ...
                <div className="grid grid-cols-3 gap-4 mb-4">
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    <div className="text-2xl font-bold text-blue-600">
                      {importResult.statistics.total_records}
                    </div>
                    <div className="text-sm text-gray-600">Total</div>
                  </div>
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    <div className="text-2xl font-bold text-green-600">
                      {importResult.statistics.successful_records}
                    </div>
                    <div className="text-sm text-gray-600">Sucessos</div>
                  </div>
                  <div className="text-center p-4 bg-red-50 rounded-lg">
                    <div className="text-2xl font-bold text-red-600">
                      {importResult.statistics.failed_records}
                    </div>
