...
export async function GET(
  ...
  try {
    ...
    if (id) {
      const data = await findById("budget_items", id);
      if (!data) {
    ...
    const data = await paginate("budget_items", {
      page,
      size,
      sort: sortField,
...
export async function POST(request: NextRequest) {
  try {
    ...
    const data = await create("budget_items", {
      ...body,
      created_by: userId,
    });
...
export async function PUT(
  ...
  try {
    ...
    const body = await request.json();
    const data = await update("budget_items", id, {
      ...body,
      updated_by: userId,
    });
...
export async function DELETE(
  ...
  try {
    ...
    await deleteById("budget_items", id);
